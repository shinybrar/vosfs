...
- implement recursive removal as client traversal and leaves-first node
  deletion, copy as client-side read/write, and move as non-atomic
  copy/recreate then delete;

...
| [Leading bytes](fsspec-cli-head-command-profile.md) | source | `local / adapted async` | `unverified` | — | Hermetic | — |
| [Leading bytes](fsspec-cli-head-command-profile.md) | source | `memory / adapted async` | `unverified` | — | Hermetic | — |
| [Leading bytes](fsspec-cli-head-command-profile.md) | source | `vosfs / native async` | `unverified` | — | Hermetic | — |
| [Trailing bytes](fsspec-cli-tail-command-profile.md) | source | `local / adapted async` | `unverified` | — | Hermetic | — |
| [Trailing bytes](fsspec-cli-tail-command-profile.md) | source | `memory / adapted async` | `unverified` | — | Hermetic | — |
| [Trailing bytes](fsspec-cli-tail-command-profile.md) | source | `vosfs / native async` | `unverified` | — | Hermetic | — |
...
| [Capability-enabled guarded recursive `rm -R`/`-r`](fsspec-cli-rm-recursive-command-profile.md) | source | `local / adapted async` | `unverified` | — | Host qualification plus symlink-race evidence | — |
| [Capability-enabled guarded recursive `rm -R`/`-r`](fsspec-cli-rm-recursive-command-profile.md) | source | `memory / adapted async` | `unverified` | — | Hermetic intended-positive qualification | — |
| [Capability-enabled guarded recursive `rm -R`/`-r`](fsspec-cli-rm-recursive-command-profile.md) | source | `vosfs / native async` | `unverified` | — | Hermetic intended-positive qualification | — |
| [Capability-enabled guarded recursive `rm` preflight](fsspec-cli-rm-recursive-command-profile.md#2-capability-and-source-free-preflight) | command preflight | `not entered` | `unverified` | — | Hermetic negative rejection | — |
| [`rm -R`/`-r` future default-capability rejection](fsspec-cli-rm-recursive-command-profile.md#2-capability-and-source-free-preflight) | command preflight | `not entered` | `unverified` | — | Hermetic negative rejection | — |
| [Current `rm -R`/`-r` recursive rejection](fsspec-cli-rm-recursive-rejection-profile.md) | command preflight | `not entered` | `unsupported` | `unsupported` | Hermetic negative rejection | [`test_rm.py` at `ed022d3`](https://github.com/shinybrar/vosfs/blob/ed022d3de5957c929c8a1836d47c0efc0d45f157/src/fsspec-cli/tests/test_rm.py) |
...
| [`rm -v`](fsspec-cli-rm-verbose-command-profile.md) | source | `local / adapted async` | `unverified` | — | Hermetic | Hermetic `test_command_matrix.py` on this change |
...
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source | `local / adapted async` | `pass` | — | Hermetic and isolated wheel | `test_command_matrix.py` and isolated-wheel recursive `cp` gate on this change |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source | `memory / adapted async` | `pass` | — | Hermetic and isolated wheel | `test_command_matrix.py` and isolated-wheel recursive `cp` gate on this change |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source | `vosfs / native async` | `pass` | — | Hermetic and isolated wheel | fully mocked `test_vosfs_command_matrix.py` and isolated-wheel gate on this change |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `local / adapted async` to `local / adapted async` | `pass` | — | Hermetic and isolated wheel | ordered-pair `test_command_matrix.py` and isolated-wheel gate on this change |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `local / adapted async` to `memory / adapted async` | `pass` | — | Hermetic and isolated wheel | ordered-pair `test_command_matrix.py` and isolated-wheel gate on this change |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `local / adapted async` to `vosfs / native async` | `pass` | — | Hermetic and isolated wheel | fully mocked ordered-pair matrix and isolated-wheel gate on this change |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `memory / adapted async` to `local / adapted async` | `pass` | — | Hermetic and isolated wheel | ordered-pair `test_command_matrix.py` and isolated-wheel gate on this change |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `memory / adapted async` to `memory / adapted async` | `pass` | — | Hermetic and isolated wheel | ordered-pair `test_command_matrix.py` and isolated-wheel gate on this change |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `memory / adapted async` to `vosfs / native async` | `pass` | — | Hermetic and isolated wheel | fully mocked ordered-pair matrix and isolated-wheel gate on this change |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `vosfs / native async` to `local / adapted async` | `pass` | — | Hermetic and isolated wheel | fully mocked ordered-pair matrix and isolated-wheel gate on this change |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `vosfs / native async` to `memory / adapted async` | `pass` | — | Hermetic and isolated wheel | fully mocked ordered-pair matrix and isolated-wheel gate on this change |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `vosfs / native async` to `vosfs / native async` | `pass` | — | Hermetic and isolated wheel | fully mocked ordered-pair matrix and isolated-wheel gate on this change |
...
| [Metadata-verified cross-source `cp`](fsspec-cli-cross-source-cp-command-profile.md) | source pair | `memory / adapted async` to `local / adapted async` | `pass` | — | Hermetic size-only boundary | Hermetic `test_command_matrix.py`; isolated-wheel gate includes this matrix |
| [Metadata-verified cross-source `cp`](fsspec-cli-cross-source-cp-command-profile.md) | source pair | `vosfs / native async` directions | `unverified` | — | Hermetic | — |
| [Metadata-verified multi-source `cp`](fsspec-cli-multi-source-cp-command-profile.md) | source | `local / adapted async` | `pass` | — | Hermetic size-only boundary | Hermetic `test_command_matrix.py`; isolated-wheel gate includes this matrix |
| [Metadata-verified multi-source `cp`](fsspec-cli-multi-source-cp-command-profile.md) | source | `memory / adapted async` | `pass` | — | Hermetic size-only boundary | Hermetic `test_command_matrix.py`; isolated-wheel gate includes this matrix |
| [Metadata-verified multi-source `cp`](fsspec-cli-multi-source-cp-command-profile.md) | source | `vosfs / native async` | `unverified` | — | Hermetic | — |
...
| [Same-source directory `mv` rejection](fsspec-cli-same-source-mv-command-profile.md#directory-admission-boundary) | source | `async source / source-reported directory` | `unsupported` | — | Hermetic negative rejection | [`e9c9fa9`](https://github.com/shinybrar/vosfs/commit/e9c9fa98bfc521628092fa7532d8ac8098d36734) `test_mv.py`; `_info` required, no target resolution, staging, or `_mv` |
| [Positively evidenced same-source multi-file `mv`](fsspec-cli-same-source-multi-file-mv-command-profile.md) | source | `local / adapted async` | `unverified` | — | Hermetic exact-operation rejection | Same `_mv` requirement as two-operand; hermetic `test_command_matrix.py` |
| [Positively evidenced same-source multi-file `mv`](fsspec-cli-same-source-multi-file-mv-command-profile.md) | source | `memory / adapted async` | `unverified` | — | Hermetic exact-operation rejection | Same `_mv` requirement as two-operand; hermetic `test_command_matrix.py` |
...
| [Cross-source `mv` deletion-guard rejection](fsspec-cli-cross-source-mv-rejection-profile.md) | command preflight | `not entered` | `unverified` | `unsupported` | Hermetic negative rejection | — |
| [Reduced BSD/macOS `stat`](fsspec-cli-bsd-macos-stat-command-profile.md) | source | `local / adapted async` | `pass` | — | Hermetic | Hermetic `test_command_matrix.py` on this change |
| [Reduced BSD/macOS `stat`](fsspec-cli-bsd-macos-stat-command-profile.md) | source | `memory / adapted async` | `unverified` | — | Hermetic | Incomplete `_info` shape; hermetic `test_command_matrix.py` proves incompatible closed-fail, not sparse pass |
| [Reduced BSD/macOS `stat`](fsspec-cli-bsd-macos-stat-command-profile.md) | source | `vosfs / native async` | `unverified` | — | Hermetic | Incomplete `_info` shape; hermetic `test_vosfs_command_matrix.py` proves incompatible closed-fail, not sparse pass |
| [Reduced `stat` option/operand rejection](fsspec-cli-bsd-macos-stat-command-profile.md#11-rejected-flags-and-shapes-source-free) | command preflight | `not entered` | `unsupported` | `unsupported` | Hermetic negative rejection | Hermetic `test_stat.py` and `test_command_matrix.py` on this change |

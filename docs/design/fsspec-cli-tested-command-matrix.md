...
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source | `vosfs / native async` | `unverified` | — | Hermetic and isolated wheel | Fully mocked `test_vosfs_command_matrix.py` added; qualifying exact-commit evidence absent |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `local / adapted async` to `local / adapted async` | `unverified` | — | Hermetic and isolated wheel | Ordered-pair `test_command_matrix.py` added; qualifying exact-commit evidence absent |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `local / adapted async` to `memory / adapted async` | `unverified` | — | Hermetic and isolated wheel | Ordered-pair `test_command_matrix.py` added; qualifying exact-commit evidence absent |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `local / adapted async` to `vosfs / native async` | `unverified` | — | Hermetic and isolated wheel | Fully mocked ordered-pair test added; qualifying exact-commit evidence absent |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `memory / adapted async` to `local / adapted async` | `unverified` | — | Hermetic and isolated wheel | Ordered-pair `test_command_matrix.py` added; qualifying exact-commit evidence absent |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `memory / adapted async` to `memory / adapted async` | `unverified` | — | Hermetic and isolated wheel | Ordered-pair `test_command_matrix.py` added; qualifying exact-commit evidence absent |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `memory / adapted async` to `vosfs / native async` | `unverified` | — | Hermetic and isolated wheel | Fully mocked ordered-pair test added; qualifying exact-commit evidence absent |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `vosfs / native async` to `local / adapted async` | `unverified` | — | Hermetic and isolated wheel | Fully mocked ordered-pair test added; qualifying exact-commit evidence absent |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `vosfs / native async` to `memory / adapted async` | `unverified` | — | Hermetic and isolated wheel | Fully mocked ordered-pair test added; qualifying exact-commit evidence absent |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | `vosfs / native async` to `vosfs / native async` | `unverified` | — | Hermetic and isolated wheel | Fully mocked ordered-pair test added; qualifying exact-commit evidence absent |

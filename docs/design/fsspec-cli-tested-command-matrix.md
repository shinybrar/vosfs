...
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source | same configured name / `local / adapted async` | `unverified` | — | Hermetic and isolated wheel | — |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source | same configured name / `memory / adapted async` | `unverified` | — | Hermetic and isolated wheel | — |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source | same configured name / `vosfs / native async` | `unverified` | — | Hermetic and isolated wheel | — |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | distinct configured names / `local / adapted async` to `local / adapted async` | `unverified` | — | Hermetic and isolated wheel | — |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | distinct configured names / `local / adapted async` to `memory / adapted async` | `unverified` | — | Hermetic and isolated wheel | — |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | distinct configured names / `local / adapted async` to `vosfs / native async` | `unverified` | — | Hermetic and isolated wheel | — |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | distinct configured names / `memory / adapted async` to `local / adapted async` | `unverified` | — | Hermetic and isolated wheel | — |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | distinct configured names / `memory / adapted async` to `memory / adapted async` | `unverified` | — | Hermetic and isolated wheel | — |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | distinct configured names / `memory / adapted async` to `vosfs / native async` | `unverified` | — | Hermetic and isolated wheel | — |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | distinct configured names / `vosfs / native async` to `local / adapted async` | `unverified` | — | Hermetic and isolated wheel | — |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | distinct configured names / `vosfs / native async` to `memory / adapted async` | `unverified` | — | Hermetic and isolated wheel | — |
| [Verified recursive `cp -R`/`-r`](fsspec-cli-recursive-cp-rejection-profile.md) | source pair | distinct configured names / `vosfs / native async` to `vosfs / native async` | `unverified` | — | Hermetic and isolated wheel | — |

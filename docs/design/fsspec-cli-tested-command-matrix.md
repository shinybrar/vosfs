...
| [Verified multi-source `cp`](fsspec-cli-multi-source-cp-command-profile.md) | source | `local / adapted async` | `pass` | — | Hermetic | Hermetic `test_command_matrix.py`; isolated-wheel gate includes this matrix |
| [Verified multi-source `cp`](fsspec-cli-multi-source-cp-command-profile.md) | source | `memory / adapted async` | `pass` | — | Hermetic | Hermetic `test_command_matrix.py`; isolated-wheel gate includes this matrix |
| [Verified multi-source `cp`](fsspec-cli-multi-source-cp-command-profile.md) | source | `vosfs / native async` | `unverified` | — | Hermetic | — |

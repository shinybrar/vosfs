...
| [Cross-source `mv` deletion-guard rejection](fsspec-cli-cross-source-mv-rejection-profile.md) | command preflight | `not entered` | `unsupported` | `unsupported` | Hermetic negative rejection | [`test_mv.py` at `4d53a5b`](https://github.com/shinybrar/vosfs/blob/4d53a5b5ffdf898e50eec95bf6b865ec7ad0cd4f/src/fsspec-cli/tests/test_mv.py#L493-L515); isolated-wheel gate runs the complete file |
